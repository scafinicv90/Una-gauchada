...
(3, 'Pasear al perro', 'La plata', 'Buenos Aires', '2017-08-23', 'Tengo un perrito, al cual no puedo pasear muy seguido. Necesito alguien que pueda llevarlo al parque por las tardesLorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod\r\ntempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,\r\nquis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo\r\nconsequat. Duis aute irure dolor in reprehenderit in voluptate velit esse\r\ncillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non\r\nproident, sunt in culpa qui officia deserunt mollit anim id est laborum.', 2),
(4, 'Cuidado de mascota', 'Avellaneda', 'Buenos Aires', '2017-08-21', 'Tengo un gato de 1 año que necesito que cuiden por las tardes. Es muy amigable, se lleva bien con otros animales y tienen Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod\ntempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,\nquis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo\nconsequat. Duis aute irure dolor in reprehenderit in voluptate velit esse\ncillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non\nproident, sunt in culpa qui officia deserunt mollit anim id est laborum.todos las vacunas al dia', 2),
(5, 'Viaje a Ezeiza', 'La plata', 'Buenos Aires', '2017-09-24', 'Tengo que realizar un viaje y necesito que alguien me lleve a Ezeiza un lunes por la tarde Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod\ntempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,\nquis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo\nconsequat. Duis aute irure dolor in reprehenderit in voluptate velit esse\ncillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non\nproident, sunt in culpa qui officia deserunt mollit anim id est laborum.', 10),
(6, 'Cuidado de anciana', 'La Plata', 'Buenos Aires', '2017-09-17', 'Buenas tardes!Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod\ntempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,\nquis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo\nconsequat. Duis aute irure dolor in reprehenderit in voluptate velit esse\ncillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non\nproident, sunt in culpa qui officia deserunt mollit anim id est laborum.', 2),
...
--
-- Estructura de tabla para la tabla `favor_has_categorias`
--

CREATE TABLE `favor_has_categorias` (
  `favor_id_favor` int(11) NOT NULL,
  `categorias_id_categoria` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Volcado de datos para la tabla `favor_has_categorias`
--
...
INSERT INTO `imagenes` (`id_imagen`, `img`, `favor_id`) VALUES
(3, 'uploads/imgFavores/perro.jpg', 3),
(4, 'uploads/imgFavores/gatito.jpg', 4),
(5, 'uploads/imgFavores/logo.png', 5),
...
--
ALTER TABLE `favor`
  ADD PRIMARY KEY (`id_favor`),
  ADD KEY `id_usuario_idx` (`id_usuario`);

--
-- Indices de la tabla `favor_has_categorias`
--
ALTER TABLE `favor_has_categorias`
  ADD PRIMARY KEY (`favor_id_favor`,`categorias_id_categoria`),
  ADD KEY `fk_favor_has_categorias_categorias1_idx` (`categorias_id_categoria`),
  ADD KEY `fk_favor_has_categorias_favor1_idx` (`favor_id_favor`);
...
ALTER TABLE `imagenes`
  ...
  ADD KEY `fk_imagenes_favor1_idx` (`favor_id`);
...
ALTER TABLE `respuestas`
  ...
  ADD KEY `id_comentario_idx` (`id_comentario`),
  ADD KEY `fk_respuestas_usuarios1_idx` (`usuarios_id`);
...
--
-- Filtros para la tabla `favor_has_categorias`
--
ALTER TABLE `favor_has_categorias`
  ADD CONSTRAINT `fk_favor_has_categorias_categorias1` FOREIGN KEY (`categorias_id_categoria`) REFERENCES `categorias` (`id_categoria`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_favor_has_categorias_favor1` FOREIGN KEY (`favor_id_favor`) REFERENCES `favor` (`id_favor`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `imagenes`
--
ALTER TABLE `imagenes`
  ADD CONSTRAINT `fk_imagenes_favor1` FOREIGN KEY (`favor_id`) REFERENCES `favor` (`id_favor`) ON DELETE NO ACTION ON UPDATE NO ACTION;
